...
public interface EmployeeController {
  ...
  @Operation(summary = "Returns a given Employee",
      ...
      parameters = {
          @Parameter(name = "name", allowEmptyValue = false, required = true,
              description = "Enter full name (i.e., 'John Smith')"),
})
  ...
  @Operation(summary = "Adds a given Employee",
      ...
      parameters = {
          @Parameter(name = "name", allowEmptyValue = false, required = true,
              description = "Enter full name (i.e., 'John Smith')"),
          @Parameter(name = "vacationHours", allowEmptyValue = false, required = false,
              description = "Current available vacation hours"),
  ...
  Employee addEmployee(
      @Length(max = 60) @Pattern(regexp = "[\\w\\s*") @RequestParam(required = true) String name,
      @Length(max = 2) Double minHours, Double vacationHours, boolean otEligible);

  
  @Operation(summary = "Updates a given Employee",
      description = "Updates Employees vacation given a first and last name",
      responses = {
